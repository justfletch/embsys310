/*******************************************************************************
File name       : divAsm.s
Description     : Assembly language function for division of input by 2
*******************************************************************************/   
...
Description     : Calls C code to print a string; 
                  computes the quotient of its input argument divided by 2
C Prototype     : int divAsm(val)
                : Where val is the value to to be divided by 2
