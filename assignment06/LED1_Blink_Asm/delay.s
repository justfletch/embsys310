...
delay
    //R0 contains the number of counts to delay
    CMP R0, #0          //See if (remaining) delay counts is zero
    BNE SUBTRACT_1      //If R0 != 0, go subtract 1 
    BX LR               //End function
    
SUBTRACT_1              //Label for subtracting 1 from R0
    SUB R0, R0, #1      //Subtract 1 from R0 (delay counts)
